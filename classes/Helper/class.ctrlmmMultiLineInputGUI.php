 ...
 */
class ctrlmmMultiLineInputGUI extends ilFormPropertyGUI {
	...
	public function render($iterator_id = 0, $clean_render = false) {
		$tpl = new ilTemplate("tpl.multi_line_input.html", true, true, $this->getTemplateDir());
		...
		if ($this->getMulti() && !$this->getDisabled()) {
			...
			$image_minus = ($show_remove) ? '<span class="glyphicon glyphicon-minus"></span>' : '<span class="glyphicon glyphicon-minus hide"></span>';
