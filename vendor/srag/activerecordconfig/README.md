...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\CtrlMainMenu\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\CtrlMainMenu\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\CtrlMainMenu\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
